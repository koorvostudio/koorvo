...
const legalContent = {
    privacy: `
    <h2 class="krv-legal__title">Política de Privacidade</h2>
    
    <div class="krv-legal__content"
        <p class="krv-legal__intro">
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">01. Coleta de Dados</h3>
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">02. Finalidade</h3>
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">03. Segurança</h3>
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">04. Seus Direitos</h3>
    ...
    <div class="krv-legal__content">
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">01. Propriedade Intelectual</h3>
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">02. Responsabilidade</h3>
        ...
        <div class="krv-legal__section">
            <h3 class="krv-legal__section-heading">03. Atualizações</h3>
